...
- [Creating an Adapter](/guides/create-adapter) - Learn how to build adapters with address validation
- [AdapterExport Type](/api/types/adapter-export) - The adapter interface that includes `supportedAddressTypes`
- [runAdapter Function](/api/utils/run-adapter) - Automatically validates addresses using these utilities